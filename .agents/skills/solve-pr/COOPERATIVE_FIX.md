...
| **solve-pr IDE** | `SKILL.md` | Manual invocation `/solve-pr` |
...
## Order of Operations (solve-pr IDE)
...
5. Execute validation (`npm test` / stack equivalent)
6. Close each resolved thread with a detailed comment (`<!-- resolution-reply -->`)
